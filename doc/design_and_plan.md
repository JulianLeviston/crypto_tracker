...
1. Create a Currency model and describe it (code, description)
2. Create an CurrencyExchangeType model and describe it (from_currency, to_currency, exchange_rate_url)
